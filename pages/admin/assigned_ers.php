<?php
$sql_farms = "SELECT * FROM emun_er WHERE $ed_code status = 1 order  by id DESC";
//search doctors
if($account_type != 'user') {
    if (isset($_POST['search'])) {
        ...
        //search
        $sql_farms = "SELECT * FROM emun_er WHERE $ed_code user_id = '$my_search' and status = 1 order  by id DESC";
    }
}
//set page pagination
...
$sql_farms = "SELECT * FROM emun_er WHERE $ed_code status = 1 order  by id DESC LIMIT $this_page_first_result , $results_per_page";
if($account_type != 'user') {
    if (isset($_POST['search'])) {
        //check user
        $sql_check = "SELECT * FROM users WHERE username = '$search' ";
        ...
        //search
        $sql_farms = "SELECT * FROM emun_er WHERE $ed_code user_id = '$my_search' and status = 1 order  by id DESC LIMIT $this_page_first_result , $results_per_page";
    }
}
//set page results
                                            ...
                                            <div class="table-responsive  mt-1">
                                                <table class="table select-table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>No.</th>
                                                        <th>Emergency</th>
                                                        <th class="mmHide">eMun Doctor</th>
